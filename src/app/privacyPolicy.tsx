  ...
  return (
    <main className="min-h-screen bg-black">
      <div className="container mx-auto px-4 py-16 max-w-4xl">
        <Link
          href="/"
          className="inline-flex items-center gap-2 px-4 py-2 border border-neutral-700 hover:border-neutral-500 text-gray-400 hover:text-white text-sm rounded-full transition-all duration-300 mb-8">
          <svg
        ...
        <section className="space-y-6 mt-8">
          ...
          <FadeInOnScroll delay={0.1}>
            <div className="bg-neutral-900/80 border border-neutral-800 rounded-lg p-6">
              ...
              <ul className="list-disc list-inside text-gray-300 space-y-2">
                <li>
                  <span className="text-white font-medium">App Functionality:</span> To provide and maintain app
                  features and services
                </li>
                <li>
                  <span className="text-white font-medium">User Experience:</span> To personalize and improve your app
                  experience
                </li>
                <li>
                  <span className="text-white font-medium">Customer Support:</span> To respond to your requests and
                  provide technical support
                </li>
                <li>
                  <span className="text-white font-medium">Analytics:</span> To understand app usage patterns and
                  improve performance
                </li>
                <li>
                  <span className="text-white font-medium">Security:</span> To detect and prevent fraud, security
                  issues, and technical problems
                </li>
                <li>
                  <span className="text-white font-medium">Legal Compliance:</span> To comply with applicable laws and
                  regulations
                </li>
              </ul>
            </div>
          ...
          <FadeInOnScroll delay={0.1}>
            <div className="bg-neutral-900/80 border border-neutral-800 rounded-lg p-6">
              ...
              <ul className="list-disc list-inside text-gray-300 space-y-2">
                <li>
                  <span className="text-white font-medium">Service Providers:</span> With third-party services that help
                  me operate my apps (analytics, crash reporting, cloud storage)
                </li>
                <li>
                  <span className="text-white font-medium">Legal Requirements:</span> When required by law or to protect
                  my rights and safety
                </li>
                <li>
                  <span className="text-white font-medium">Business Transfers:</span> In connection with a merger, sale,
                  or transfer of assets
                </li>
                <li>
                  <span className="text-white font-medium">Consent:</span> With your explicit consent for specific
                  purposes
                </li>
              </ul>
            </div>
          ...
          <FadeInOnScroll delay={0.15}>
            <div className="bg-neutral-900/80 border border-blue-500/20 rounded-lg p-6">
              ...
              <div className="space-y-2 text-gray-300">
                <p>
                  <span className="text-white font-medium">Email:</span> mk@mikaelkortbaoui.dev
                </p>
                <p>
                  <span className="text-white font-medium">Developer:</span> Mikael Kortbaoui
                </p>
                <p>
                  <span className="text-white font-medium">Location:</span> Montreal, Canada
                </p>
                <p>
                  <span className="text-white font-medium">Response Time:</span> I aim to respond to all inquiries
                  within 48 hours
                </p>
              </div>
            </div>
